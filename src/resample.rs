...
use image::{imageops, DynamicImage, RgbaImage, GenericImageView, imageops::FilterType, ImageFormat};
...
mod nearest {
    ...
    use crate::Size;
    use image::{imageops, DynamicImage, RgbaImage, GenericImageView, imageops::FilterType};
