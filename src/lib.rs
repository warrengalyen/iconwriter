...
mod tests {
    ...
    fn create_icon() {
        let sources = [
            SourceImage::from_file(r"..\lib\tests\6.png").unwrap(),
            SourceImage::from_file(r"..\lib\tests\20.png").unwrap(),
            SourceImage::from_file(r"..\lib\tests\24.png").unwrap(),
            SourceImage::from_file(r"..\lib\tests\icon.svg").unwrap()
        ];
        ...
        icon.write(std::fs::File::create(r"..\lib\tests\icon.ico").unwrap()).unwrap();
    }
}